public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Spider s1 = new Spider(frontier, visitedPages, storage);
        Spider s2 = new Spider(frontier, visitedPages, storage);
        Spider s3 = new Spider(frontier, visitedPages, storage);
        Spider s4 = new Spider(frontier, visitedPages, storage);
        Spider s5 = new Spider(frontier, visitedPages, storage);
        Spider s6 = new Spider(frontier, visitedPages, storage);
